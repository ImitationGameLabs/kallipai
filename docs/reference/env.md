...
| `KALLIP_MAX_TOOL_ROUNDS`             | _(unlimited)_         | > 0                                                    | Maximum tool-call rounds per agent. Defaults to unlimited — the tagma-wide token budget is the primary safety net. Set this to enforce a hard round limit independent of token consumption (e.g. for testing or cost control).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
