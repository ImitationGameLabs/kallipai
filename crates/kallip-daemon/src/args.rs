...
/// CLI arguments for kallip-daemon.
#[derive(Parser)]
#[command(
    name = "kallip-daemon",
...
pub struct Args {
    ...
    #[arg(long, env = "KALLIP_DAEMON_ADDR", default_value = "127.0.0.1:3000")]
    ...
    /// User-Agent sent on outbound LLM HTTP calls. Unset = `kallip/<daemon-version>`.
